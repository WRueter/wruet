...
public final class Constants {
    ...
    public static final double SPEED_SCALE = 0.15;
     ...
     */
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = util.inchesToMeters(21.75); // FIXME Measure and set trackwidth
    /**
     * The front-to-back distance between the drivetrain wheels.
     *
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = util.inchesToMeters(23.75); // FIXME Measure and set wheelbase
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(205.9 + 180); // FIXME Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(177.6 + 180); // FIXME Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(327.7 + 180); // FIXME Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(160.5 + 180); // FIXME Measure and set back right steer offset
}
